...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { rx_data_ready_out }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { n_request_tx }]; #IO_L9P_T1_DQS_14 Sch=btnc
